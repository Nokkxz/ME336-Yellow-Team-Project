...
class URController(ArmController):
    ...
    def gripperGrasp(self):
        self.set_tool_out(0, True)

    def gripperOpen(self):
        self.set_tool_out(0, False)
...
if __name__ == '__main__':
    ...
    print(state)
    # test1 = [-0.043617317252449175, -0.4880706562350242, 0.08024145413053396, 3.0975808521010926, 0.2356331538886279, -0.029430872203195072]
    # robot.move_L(test1, 2, 2)
    test2 = [-0.043617317252449175, -0.4880706562350242, 0.08, 3.0975808521010926, 0.2356331538886279,
             -0.029430872203195072]
    # robot.move_L(test2, 2, 2)
    # robot.set_tool_out(0, True)
    # robot.set_tool_out(0, False)
    test3 = np.copy(test2)
    test3[:2] = [-0.05026695, -0.47756764]
    test4 = [-0.1395, -0.22007, 0.11417, 2.2215, -2.2215, 0.0]
    robot.move_L(test4)
    # robot.gripperGrasp()
    # robot.gripperOpen()
